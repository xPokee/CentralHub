...
public class BubberBanService(HttpClient client, ILogger<BubberBanService> logger) : HttpBanService(client, logger)
{
    protected override string BaseUrl => "CHANGE THIS TO THE BUBBER PARSED LOGS URL";
